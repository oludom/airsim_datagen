...
class DaggerClient(SimClient):
    ...
    def __init__(self, modelPath=None, raceTrackName=track_name, device='cpu', beta=0.99, *args, **kwargs):
        super().__init__(modelPath, raceTrackName = track_name , device , *args, **kwargs)
        self.beta = beta
    ...
    def gateMission(self, showMarkers=True, captureImages=True):
        ...
        while mission:
            ...
            if nextImage and captureImages:
                ...
                AirSimInterface.captureAndSaveImages(cwpindex, cimageindex, [*Bvel, Byaw])
                cimageindex += 1
...
if __name__ == "__main__":
    ...
    with contextlib.closing(DaggerClient(
            ...
            device="cuda", raceTrackName= track_name)) as dc:
